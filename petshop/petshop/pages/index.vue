...
const addCart = async () => {
  const { data } = await useFetch("http://110.42.190.78:8888/addcart", {
    method: "post",
    body: {
      goodsNo: 3,
      img: "http://110.42.190.78:8888/img/4.png",
...
let { data:res3 } = await useFetch(`http://110.42.190.78:8888/api/prefe/prefe`);
if (res3.value) {
...
let goods1 = ref([]);
let goods2 = ref([]);
let { data } = await useFetch(`http://110.42.190.78:8888/api/test/test`);
if (data.value) {
